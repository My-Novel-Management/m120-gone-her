...
def sc_girls_school(w: World):
    ...
    return w.scene("女子学校",
            ...
            yuki.be("エアコンが効きすぎてぬるっとした午後に、やたらと発音の良い英語の先生の途切れないニューヨークの旅行話を聞きながら、",
            ...
            inside.look("教室には自分と同じ白のブレザーを着込んだ十七歳の女子が、くすくすと笑ったり半分眠ったような態度で座っている", "&"),
            _.look("黒板の中央にはＬｉｌｙと綺麗な筆記体の文字が赤いチョークで書かれているのに、右端の日直という字とそこに書かれている名前は丸文字で、おまけに花まで咲いていた"),
            yuki.do("中学から大学までを揃えた女子校は途中編入の人間には馴染み難い",
                "年頃の彼女たち特有の汗の匂いが閉め切られた少し暑いくらいの室内に籠もっているということを、部外者である自分だけが感じている"),
            stu.talk("ねえ、今日も放課後、いく？"),
            yuki.do("後ろの席から$Sに関係のないおしゃべりが聞こえてくるが、先生は注意する様子はなく、",
                "それを了承と捉えたのか、そこここで一斉に声のボリュームが上がった",
                "携帯を持つことを禁じられても、女子たちの好奇心に蓋はできない"),
...
def sc_longing(w: World):
    ...
    return w.scene("憧れの彼女",
            ...
            _.look("黒髪に包まれるようにしてある小さな顔には大きな瞳がよく目立ち、しゅっとした顎の上、唇が小指で引いた紅のように控え目に乗っている",
                "美人というより美人形という形容がよく似合う", "そんな彼女を誰もが憧れの吐息で見つめていた"),
            yuki.do("彼女が廊下側を見て、小さく手を振る", "ただそれだけで下級生たちは歓声を上げる",
                "誰かが今自分と目が合ったと喜んでいたが、$full_arisuの瞳が一瞬$Sを捉えて大きくなった"),
            yuki.think("――$meを、見ている？"),
            suzaki.come(),
            suzaki.look("そこにショートカットの背の高い女子が戻ってきて、人混みをかき分けながら彼女の前まで歩いていく"),
...
def sc_vanishing(w: World):
    ...
    return w.scene("彼女が消えた日",
            ...
            stu.talk("大変なの！　$fn_arisu先輩が、消えた"),
            w.eventStart("$arisu失踪"),
            yuki.talk("え？"),
            yuki.do("それを耳にして、普段教室で声なんて上げることないのに、$Sは立ち上がって問いかけていた"),
            yuki.talk("$ln_arisuさんが？"),
            stu.talk("う、うん。そうなのよ",
                "事情はよく分からないけど先輩たちが話してるのを聞いたって"),
            yuki.do("$Sは慌てて三年二組の教室へと向かったけれど、すぐにそれが事実だと集まった生徒たちや追い払おうとする先生たちから知らされ、",
                "その日はシャワーを浴びることもなく脱力したまま寮のベッドで眠った"),
            yuki.do("既に廊下には生徒が集まって騒動になっていて、それを追い払おうと先生たちが自分の教室に帰るように声を荒げていた").omit(),
            yuki.explain("その後改めて担任の教師から話があり、$full_arisuが学校からいなくなったことが知らされた").omit(),
            stage=w.on_school,
            ## NOTE
            ##  ここで事件開始
            day=w.in_goodbye,
